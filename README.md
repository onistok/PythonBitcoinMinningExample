...
Aynı zamanda tüm değşikenleri ayarlamış ve doğru sıra ile hash üretmiş olsaydık bile, bitcoin madenciliği yapmak için bitcoin-core çekirdeğini indirerek full node denilen bu güne kadarki tüm işlemleri çekmiş ve doğrulamış olmanız gerekmektedir. Buda yaklaşık 400 GB ve birkaç hafta alacaktır. Tüm bu data olmadan değişkenler içinde Zorunlu İstenen verilere sahip olamazdınız. Aynı zamanda yeni hash i ürettiğinizde ve bunu ağdaki diğer madenciler ile doğru şekilde paylaştığınızda ve onlardan biri dahi bunu doğruladığında bitcoin üretmiş sayılacaksınız.
